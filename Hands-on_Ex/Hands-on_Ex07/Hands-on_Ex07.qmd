...
```{r}
pacman::p_load(rootSolve,lmom,expm,Exact,gld,productplots,DescTools,ggmosaic,CGPfunctions,knitr,data.table,ggthemes,scales,readxl,readr,dplyr,tidyverse,extrafont)
```

## **17.4 Plotting Calendar Heatmap**

In this section, we will learn on how to plot a calender heatmap programmatically by using ggplot2 package.
...
rice %>% 
  ...
  newggslopegraph(Year, Yield, Country,
                ...
                SubTitle = "1961-1980",
                Caption = "Prepared by: Enrico Limberg")
```
